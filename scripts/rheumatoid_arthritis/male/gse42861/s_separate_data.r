...
female_control <- subset(disease_state, disease_state[,2] =="1" & disease_state[,4] == "1")
...
vec_age_female_diseased <- as.numeric(female_diseased[,3])
save(vec_age_female_diseased, file = "vec_age_female_diseased.r")
