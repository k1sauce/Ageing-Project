load("~/R/ageing/datasets/nafld/males/probe_index_gw.r")
...
tmp <- probe_index_gw
age_yx_controls <- as.matrix(na_fill_mvalues_male_liver_controls[tmp,])
age_yx_controls <- rbind(vec_age_male_controls, age_yx_controls)
rownames(age_yx_controls)[1] <- "age"


control_index <- sample(dim(na_fill_mvalues_male_liver_controls)[2], 0.7*dim(na_fill_mvalues_male_liver_controls)[2])

age_yx_train_controls <- age_yx_controls[,control_index]
age_yx_test_controls <- age_yx_controls[,-control_index]

save(age_yx_train_controls,file = "~/R/ageing/datasets/nafld/males/age_yx_train_controls.r")
save(age_yx_test_controls, file = "~/R/ageing/datasets/nafld/males/age_yx_test_controls.r")
...
x_train <- as.matrix(age_yx_train_controls[,2:410])
y_train <- as.matrix(age_yx_train_controls[,1])
x_test <- as.matrix(age_yx_test_controls[,2:410])
...
model %>% 
  ...
  layer_dense(units = 409, activation = 'relu', input_shape = c(409)) %>% 
...
tmp <- probe_index_gw
age_yx_diseased <- na_fill_mvalues_male_liver_diseased[tmp,]
age_yx_diseased <- t(age_yx_diseased)
save(age_yx_diseased, file = "~/R/ageing/datasets/nafld/males/age_yx_disease.r")
load("~/R/ageing/datasets/nafld/males/age_yx_disease.r")
save_model_hdf5(model, filepath = "~/R/ageing/datasets/nafld/males/tf_model_male_age.r", overwrite = TRUE,
