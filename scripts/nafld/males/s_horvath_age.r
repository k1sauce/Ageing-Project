...
save(horvath_age, file="~/R/ageing/datasets/nafld/males/age_yx_test_controls_horvath_estimate.r")
...
save(horvath_age,file = "~/R/ageing/datasets/nafld/males/male_diseased_betas_horvath_estimate.r")
